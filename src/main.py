...
def main():
    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter, usage="Command line")
    subparsers = parser.add_subparsers()

    hparams = make_hparams()
    subparser = subparsers.add_parser("train", formatter_class=argparse.ArgumentDefaultsHelpFormatter, usage="Train command")
    subparser.set_defaults(callback=lambda args: run_train(args, hparams))
    hparams.populate_arguments(subparser)
    subparser.add_argument("--numpy-seed", type=int, help=" ")
    subparser.add_argument("--model-path-base", required=True, help=" ")
    subparser.add_argument("--evalb-dir", default="EVALB/", help=" ")
    subparser.add_argument("--train-path", default="data/02-21.10way.clean", help=" ")
    subparser.add_argument("--dev-path", default="data/22.auto.clean", help=" ")
    subparser.add_argument("--batch-size", type=int, default=250, help=" ")
    subparser.add_argument("--subbatch-max-tokens", type=int, default=2000, help=" ")
    subparser.add_argument("--eval-batch-size", type=int, default=100, help=" ")
    subparser.add_argument("--epochs", type=int, help=" ")
    subparser.add_argument("--checks-per-epoch", type=int, default=4, help=" ")
    subparser.add_argument("--print-vocabs", action="store_true", help=" ")

    subparser = subparsers.add_parser("test", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    subparser.set_defaults(callback=run_test)
    subparser.add_argument("--model-path-base", required=True, help=" ")
    subparser.add_argument("--evalb-dir", default="EVALB/", help=" ")
    subparser.add_argument("--test-path", default="data/23.auto.clean", help=" ")
    subparser.add_argument("--test-path-raw", type=str, help=" ")
    subparser.add_argument("--eval-batch-size", type=int, default=100, help=" ")

    subparser = subparsers.add_parser("ensemble", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    subparser.set_defaults(callback=run_ensemble)
    subparser.add_argument("--model-path-base", nargs='+', required=True, help=" ")
    subparser.add_argument("--evalb-dir", default="EVALB/", help=" ")
    subparser.add_argument("--test-path", default="data/22.auto.clean", help=" ")
    subparser.add_argument("--eval-batch-size", type=int, default=100, help=" ")

    subparser = subparsers.add_parser("parse", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    subparser.set_defaults(callback=run_parse)
    subparser.add_argument("--model-path-base", required=True, help=" ")
    subparser.add_argument("--input-path", type=str, required=True, help=" ")
    subparser.add_argument("--output-path", type=str, default="-", help=" ")
    subparser.add_argument("--eval-batch-size", type=int, default=100, help=" ")

    subparser = subparsers.add_parser("viz", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    subparser.set_defaults(callback=run_viz)
    subparser.add_argument("--model-path-base", required=True, help=" ")
    subparser.add_argument("--evalb-dir", default="EVALB/", help=" ")
    subparser.add_argument("--viz-path", default="data/22.auto.clean", help=" ")
    subparser.add_argument("--eval-batch-size", type=int, default=100, help=" ")
